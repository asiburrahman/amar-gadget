  ...
  `;
    ...
    const products = await prisma.product.createMany({
        data: [
            ...
            {
                name: 'Men\\', s, Casual, Shirt, ',: description, 'Comfortable cotton casual shirt for everyday wear': ,
                price: 49.99,
                stock: 100,
            ...
            {
                name: 'Women\\', s, Running, Shoes, ',: description, 'Lightweight running shoes with responsive cushioning': ,
                price: 89.99,
                stock: 75,
